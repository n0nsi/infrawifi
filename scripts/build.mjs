...
// Explicit publication allowlist: never copy the repository root or recurse over it.
export async function build(source = root) {
  ...
  // Replace only the generated directory, after all source reads have succeeded.
